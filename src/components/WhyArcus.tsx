...
export default function WhyArcus({ onClose, onShowComingSoon, onShowContact, onShowProduct, onShowCodeModal, onShowFAQ }: WhyArcusProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section class="vs-compare pad-viewport" id="compare">
  <div class="wrapper vs-compare__wrapper">
    <h2 class="vs-compare__title">Quick comparison guide</h2>
    <div class="vs-compare__table-wrapper">
      <table class="compare-table">
  <thead>
    <tr>
      
        <th class="compare-table__heading compare-table__heading--feature">Feature</th>
      
        <th class="compare-table__heading compare-table__heading--sketch">Sketch</th>
      
        <th class="compare-table__heading compare-table__heading--figma">Figma</th>
  ...
  <tbody>
      ...
      <tr class="compare-table__row">
        <td class="compare-table__cell compare-table__cell--feature styled-text">
          <div class="compare-table__cell-content">
              <span class="tooltip tooltip--new" aria-label="Available with a Workspace and subscription">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" class="tooltip__icon"><defs><clipPath id="prefix__a__information"><path d="M7.245 0c1.55 0 2.708.278 3.686.801a5.452 5.452 0 012.268 2.268c.523.978.801 2.136.801 3.686v.49c0 1.55-.278 2.708-.801 3.686a5.452 5.452 0 01-2.268 2.268c-.978.523-2.136.801-3.686.801h-.49c-1.55 0-2.708-.278-3.686-.801A5.452 5.452 0 01.801 10.93C.278 9.953 0 8.795 0 7.245v-.49c0-1.55.278-2.708.801-3.686A5.452 5.452 0 013.07.801C4.047.278 5.205 0 6.755 0h.49z"></path></clipPath><clipPath id="prefix__b__information"><path d="M1 0a1 1 0 110 2 1 1 0 010-2z"></path></clipPath></defs><g clip-path="url(#prefix__a__information)" transform="translate(1 1)"><path id="background" fill="rgba(255, 255, 255, 0.15)" d="M0 0h14v14H0V0z"></path><path d="M7 10V6.25H6m-.5 4h3" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-miterlimit="10"></path><g clip-path="url(#prefix__b__information)" transform="translate(6 2)"><path d="M0 0h2v2H0V0z" stroke="currentColor" fill="currentColor"></path></g></g></svg>

              </span>
            <p>Real-time collaboration</p>
</div>
        </td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
      </tr>
      ...
      <tr class="compare-table__row">
        <td class="compare-table__cell compare-table__cell--feature styled-text">
          <div class="compare-table__cell-content">
            <p>iPhone and iPad viewing app</p>
</div>
        </td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
      ...
      <tr class="compare-table__row">
        <td class="compare-table__cell compare-table__cell--feature styled-text">
          <div class="compare-table__cell-content">
            <p>Powerful native Mac app</p>
</div>
        </td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
        <td class="compare-table__cell compare-table__cell--no"></td>
      </tr>
    
      <tr class="compare-table__row">
        <td class="compare-table__cell compare-table__cell--feature styled-text">
          <div class="compare-table__cell-content">
            <p>Full offline workflow</p>
</div>
        </td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
        <td class="compare-table__cell compare-table__cell--no"></td>
      ...
      <tr class="compare-table__row">
        <td class="compare-table__cell compare-table__cell--feature styled-text">
          <div class="compare-table__cell-content">
            <p>Documents not limited by browser memory</p>
</div>
        </td>
        <td class="compare-table__cell compare-table__cell--yes"></td>
        <td class="compare-table__cell compare-table__cell--no"></td>
    ...
    <div class="vs-compare__artwork"><img class="vs-compare__artwork__image" srcset="
          https://sktch.b-cdn.net/assets/pages/vs/compare.artwork.png?width=300&amp;token=rrflVWpsIlI11MDNFF7dcC_KwfQarSHoSMDYHclRynU&amp;expires=1767706247 1x,
          https://sktch.b-cdn.net/assets/pages/vs/compare.artwork.png?width=600&amp;token=j721LSkUTJ3v5hp5fU_64wxCj_LJZMbl6rZFFqK6lqw&amp;expires=1767706247 2x
        " alt="Briefcase and diamond" draggable="false" loading="lazy">
    </div>
  </div>
</section>
