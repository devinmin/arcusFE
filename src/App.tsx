        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-10 leading-relaxed max-w-2xl mx-auto">
              Arcus AI can cut non-working marketing dollars by 85%+. Augment your team or replace your agency with a senior marketer + AI that provides strategy, brand intuition, and creative direction.
            </p>
